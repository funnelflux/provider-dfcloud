...
export TERRAFORM_PROVIDER_SOURCE ?= dragonflydb/dfcloud
export TERRAFORM_PROVIDER_REPO ?= https://github.com/dragonflydb/terraform-provider-dfcloud
export TERRAFORM_PROVIDER_VERSION ?= 0.0.22
